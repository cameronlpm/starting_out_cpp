...
int main()
{
    ...
    AuxiliaryOffice auxOffices[4];   // Array of AuxiliaryOffice objects
    ...
    for (count = 0; count < NUM_DIVISIONS; count++)
    {
        ...
        cout << "Enter the budget request for that divison's auxiliary office: ";
        cin >> budgetAmount;
