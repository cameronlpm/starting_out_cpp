...
int main()
{
    ...
    // Free the dynamically allocated memory and set the pointers to zero
    delete[] dup1;
    delete[] dup2;
    delete[] dup3;
    dup1 = nullptr;
...
// duplicateArray accents an int array and an int that indicates the array's size.
// The function creates a new array that is a duplicate of the argument array,
// and returns a pointer to the new array. If an invalid size is passed,
...
// displayArray accepts an int array and a size argument, and display the array's contents
