...
// displayMenu will display the user's menu on the screen
void displayMenu()
{
    cout << "\n                         MENU\n";
    cout << "--------------------------------------------------\n";
...
// makeDeposit accepts a reference to an Account object, and prompts
// the user for the dollar amount of the deposit. The makeDeposit
...
// The withdraw function accepts a reference to an Account object, and prompts
// the user for the dollar amount of the withdrawal. The withdraw member of
// the Account object is then called.
